  ...
  return (
    <section className="relative overflow-hidden bg-[#f8f4ed] px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
      ...
      <div className="relative mx-auto max-w-[1180px]">
        ...
        <p className="mx-auto mt-7 max-w-4xl text-center text-sm leading-6 text-stone-600">Today, the Association&apos;s central role is to support the preparation of tea for auction, manage the sale process, and handle the final documentation for sellers and buyers. Working alongside the Ceylon Chamber of Commerce and the Colombo Tea Traders&apos; Association, the CBA remains a vital link in the Sri Lanka Tea Trade.</p>
      </div>
    </section>
  )
}
