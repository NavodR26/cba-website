export default function AboutSection() {
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white dark:bg-neutral-950 relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto text-center relative z-10">
        ...
        <h2 className="mt-3 text-4xl md:text-5xl font-bold text-gray-900 dark:text-white animate-fade-in-scale" style={{ animationDelay: '0.1s' }}>
          Leading Sri Lanka&apos;s Auction Industry
        </h2>

        <p className="text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mt-4 text-lg leading-relaxed animate-fade-in-scale" style={{ animationDelay: '0.2s' }}>
        ...
        <div className="grid md:grid-cols-2 gap-6 text-left mt-10 max-w-5xl mx-auto">
          {/* VISION */}
          <div className="p-8 rounded-2xl border border-gray-200/60 dark:border-neutral-800 bg-gradient-to-br from-white/90 to-gray-50/50 dark:from-neutral-900/50 dark:to-neutral-900/30 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group overflow-hidden relative">
            ...
            <div className="relative">
              ...
              <h3 className="font-bold text-xl mb-3 text-[var(--maroon)] dark:text-amber-300 group-hover:translate-x-1 transition-transform duration-300">
                Vision
              </h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                A transparent, efficient, and globally competitive auction system that leads the region.
              </p>
            </div>
          </div>

          {/* MISSION */}
          <div className="p-8 rounded-2xl border border-gray-200/60 dark:border-neutral-800 bg-gradient-to-br from-white/90 to-gray-50/50 dark:from-neutral-900/50 dark:to-neutral-900/30 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group overflow-hidden relative" style={{ animationDelay: '0.1s' }}>
            ...
            <div className="relative">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                Uphold integrity, enhance standards, and support sustainable growth across all sectors.
              </p>
            </div>
          </div>
        </div>
