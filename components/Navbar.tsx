...
//   return (
//     <header className="fixed top-0 left-0 right-0 z-40 backdrop-blur-md bg-white/75 border-b border-white/20 shadow-sm hover-glow transition-all duration-300">
//       <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 h-[72px] flex justify-between items-center gap-4 animate-fade-in-scale">
//         {/* LOGO */}
