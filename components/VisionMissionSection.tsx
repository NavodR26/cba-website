  ...
  return (
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-[1200px] mx-auto">
        ...
        >
          <span className="inline-block px-4 py-1.5 rounded-full bg-[var(--maroon)]/10 text-[var(--maroon)] text-xs font-semibold uppercase tracking-wider mb-4">
            Our Purpose
          </span>
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 mb-12 md:mb-16">
          ...
          <motion.article
            ...
            className="bg-white rounded-2xl p-6 md:p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 group"
          >
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[var(--maroon)]/20 to-[var(--maroon)]/10 flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300">
              <svg className="w-6 h-6 text-[var(--maroon)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <motion.article
            ...
            className="bg-white rounded-2xl p-6 md:p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 group"
          >
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-amber-400/20 to-amber-400/10 flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="mt-6 pt-4 border-t border-gray-100 flex flex-wrap gap-2">
              {['Transparency', 'Standards', 'Technology', 'Sustainability'].map((tag) => (
                <span
                  key={tag}
                  className="px-3 py-1 rounded-full text-xs font-medium bg-gray-50 text-gray-600 border border-gray-200 hover:border-[var(--maroon)] hover:text-[var(--maroon)] transition-colors duration-200"
                >
                  {tag}
                </span>
              ))}
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-[var(--maroon)] to-[#5a1620] rounded-2xl p-6 md:p-8"
        >
          <div className="grid grid-cols-3 gap-4 md:gap-8">
            <div className="text-center">
              <p className="text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-1">
                {yearsCount}+
              </p>
              <p className="text-xs md:text-sm text-amber-300 uppercase tracking-wider">
                Years of Excellence
              </p>
            </div>
