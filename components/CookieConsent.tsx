    ...
    <AnimatePresence>
      {!isMinimized ? (
        <motion.aside
          ...
          className="fixed bottom-5 right-3 z-[9998] w-[calc(100%-1.5rem)] max-w-sm overflow-hidden rounded-2xl border border-white/70 bg-white/95 shadow-[0_20px_60px_rgba(39,16,24,0.22)] backdrop-blur-xl sm:bottom-6 sm:right-6 sm:w-[23rem]"
        >
          ...
          <div className="relative p-5">
            ...
            <div className="flex gap-3 pr-8">
              ...
              <div>
                <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#9b7628]">Website preferences</p>
                <h3 className="mt-0.5 text-base font-semibold text-slate-900">Cookie settings</h3>
              </div>
            </div>

            <p className="mt-4 text-[13px] leading-6 text-slate-600">Essential cookies support secure operation. Optional analytics help improve our services.</p>
        ...
        <motion.button
          ...
          className="fixed bottom-20 right-3 z-[9998] flex items-center gap-2 rounded-full border border-white/20 bg-[var(--maroon)] px-4 py-2.5 text-white shadow-xl transition hover:-translate-y-0.5 hover:shadow-2xl sm:bottom-6 sm:right-6"
        >
