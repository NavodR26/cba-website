...
function InfoWidget() {
  ...
  return (
    <div className="relative">
      ...
      {isExpanded && (
        <div className="absolute right-0 top-full mt-2 w-64 sm:w-72 bg-white/95 backdrop-blur-xl rounded-xl shadow-2xl border border-white/20 overflow-hidden animate-fade-in-scale z-50">
