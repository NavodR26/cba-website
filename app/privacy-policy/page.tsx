    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-6 sm:py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
          <div className="bg-gradient-to-r from-[var(--maroon)] to-[#681721] px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-white font-semibold">Privacy Policy Document</p>
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
          <p>For questions about our Privacy Policy, contact us at <a href="mailto:info@cbasl.lk" className="text-[var(--maroon)] hover:underline font-medium">info@cbasl.lk</a></p>
        </div>
      </div>
    </div>
  )
